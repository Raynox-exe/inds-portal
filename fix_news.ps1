$content = Get-Content 'c:\Users\Danie\OneDrive\Desktop\IND\index.html' -Raw -Encoding UTF8
...
Set-Content 'c:\Users\Danie\OneDrive\Desktop\IND\index.html' -Value $content -Encoding UTF8
Write-Host "Done"
